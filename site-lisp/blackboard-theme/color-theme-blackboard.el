...
(defun color-theme-blackboard ()
  ...
  (color-theme-install
   '(color-theme-blackboard
	 ...
	 (default ((t (:background "#0B161D" :foreground "#F8F8F8"))))
	 ...
	 (font-lock-function-name-face ((t (:foreground "#F8F8F8"))))
	 (font-lock-keyword-face ((t (:foreground "#61CE3C"))))
     ...
     (font-lock-string-face ((t (:foreground "#FBDE2D"))))
	 ...
	 (mode-line ((((class color) (min-colors 88)) (:background "DarkRed" :foreground "White" :box (:line-width -1 :style released-button)))))
